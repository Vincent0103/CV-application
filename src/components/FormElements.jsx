...
const FormElements = (
  ...
  const addBtn = () => {
    ...
    const General = ({ dataKey, innerCategory }) => {
      const handleClickParameterized = () => handleAddOrRemoveBtnClick('general', dataKey);
  ...
  const removeBtn = () => {
    ...
    const General = ({ dataKey, dataId, innerCategory }) => {
      const handleClickParameterized = () => handleAddOrRemoveBtnClick('general', dataKey, dataId);
